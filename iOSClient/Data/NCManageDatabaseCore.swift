...
final class NCManageDatabaseCore {
    ...
    func warmUpRealmAsync() {
        // 0xdead10cc-Hinweis (Run 14.09.): der Realm-Open haelt einen
        // fcntl-Lock. Der Schutz (Background-Task) liegt bei den
        // Aufrufstellen im App-Target (diese Datei wird auch von den
        // Extensions kompiliert - dort ist UIApplication.shared nicht
        // verfuegbar).
